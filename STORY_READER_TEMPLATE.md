...
- `src/styles/global.css` defines the reusable narrator, child, human character, machine, house, and wind treatments, including the soft wind-wake behind the currently spoken word.
